...
Both countries follow the same seasonal shape every year. Performance drops from October through January and recovers into spring. January is consistently the worst month. This pattern held across the full 2019-2026 dataset.
...
| Dashboard | Power BI Desktop | Built 4-page interactive dashboard connected live to PostgreSQL |
...
4. Set up PostgreSQL, create database `nhs_project`, and load the processed CSVs
...
Built by Emi Igein. MSc Data Science (Distinction). Targeting NHS and Civil Service junior data analyst roles in the UK.
